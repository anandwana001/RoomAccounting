...
import com.akshay.atlysaccounting.databinding.FragmentDisplayInvoiceBinding
import com.akshay.atlysaccounting.databinding.MinimalInvoiceItemBinding
...
/**
 * Main Fragment of the Atlys Accounting app.
 */
@AndroidEntryPoint
class DisplayInvoiceFragment : Fragment() {
  ...
  private fun createAtlysRecyclerViewAdapter(): AtlysRecyclerViewAdapter<DisplayInvoiceItemViewModel> {
