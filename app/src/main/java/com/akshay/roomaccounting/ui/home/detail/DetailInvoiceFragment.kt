...
import com.akshay.roomaccounting.databinding.DetailInvoiceDetailItemBillItemBinding
import com.akshay.roomaccounting.databinding.DetailInvoiceDetailItemBinding
import com.akshay.roomaccounting.databinding.DetailInvoiceStatusItemBinding
import com.akshay.roomaccounting.databinding.FragmentDetailInvoiceBinding
import com.akshay.roomaccounting.ui.home.detail.DeleteConfirmationDialogFragment.Companion.TAG_DELETE_CONFIRMATION_FRAGMENT
...
class DetailInvoiceFragment : Fragment(), DeleteConfirmationListener {
  ...
  private fun createRoomAccRecyclerViewAdapter(): RoomAccRecyclerViewAdapter<DetailInvoiceItemViewModel> {
  ...
  private fun bindDetailViewModel(
    ...
    binding.itemRecyclerView.apply {
      adapter = createRoomAccItemRecyclerViewAdapter()
    }
  }

  private fun createRoomAccItemRecyclerViewAdapter(): RoomAccRecyclerViewAdapter<SingleEntryInvoiceViewModel> {
  ...
  private fun setUpListeners() {
    ...
    binding.deleteButton.setOnClickListener {
      val dialogFragment = DeleteConfirmationDialogFragment.newInstance(id = invoiceId)
